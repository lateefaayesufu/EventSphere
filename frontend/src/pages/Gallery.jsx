...
const Gallery = () => {
  ...
  // Generic handlers to reduce code duplication
...
<section  >
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Video 1 */}
            <div
              className="bg-white h-96 shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition duration-300"
      ...
      {/* ✅ Video Card with Hover-to-Play */}
           <div
  className="bg-white w-78 h-96 ml-5 shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition duration-300"
