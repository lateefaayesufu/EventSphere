    ...
    <section className="py-20 bg-gradient-to-r from-[#1E1F2E] via-[#1A1B1B] to-[#2B2426] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          <h3 className="text-3xl sm:text-4xl md:text-5xl font-black mb-6 bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text text-transparent leading-tight">
            Real Stories from
